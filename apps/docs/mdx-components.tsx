...
import { SourceCodeToggle } from '@/app/components/source-code-toggle';

export function useMDXComponents(components: MDXComponents): MDXComponents {
  return {
    h1: ({ children }) => <h1 className="text-3xl font-bold tracking-tight md:text-4xl mb-4">{children}</h1>,
    h2: ({ children }) => <h2 className="text-2xl font-semibold tracking-tight mt-10 mb-4 border-b pb-2">{children}</h2>,
